...
<html lang="en">
 ...
 <%@ include file="../header.jsp" %>
  ...
  <div class="site-section">
    <div class="container">
    	<form action="commnoticeupdate.do" method="post" id="submitForm" >
		      ...
		      <table class="table">
		        <div style="text-align: center; padding-bottom: 10px;">
		          ...
		          <tr>
		            ...
		            <td><input type="text" class="form-control" id="notice_title" name="notice_title" value="${notice.notice_title }"></td>
		          </tr>
		          <tr>
		          ...
		          <tr>
		            <td colspan="2">
		              <textarea class="form-control" id="p_content" name="notice_content">${notice.notice_content }</textarea>
		              <script type="text/javascript">
		          ...
		          <tr>
		            <td colspan="2" style="text-align: right;">
		              <input type="button" class="btn btn-success" id="submitBtn" value="수정" style="display: inline-block;">
		              <input type="button" value="취소" class="btn btn-success" style="display: inline-block;" onclick="location.href='noticedetail.do?notice_num=${notice.notice_num }&pro_num=${pro_num }'">
		            </td>
		          </tr> 
		      </table>
