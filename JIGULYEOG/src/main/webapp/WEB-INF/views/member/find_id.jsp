        ...
        <div class="col-md-6 pr-md-5" style="margin: 0 auto;">
          <form action="searchId.do" method="POST">
            <div class="form-group loginbox">
              <input type="text" class="form-control px-3 py-2" placeholder="Phone" style="width: 500px;" name="user_phone" id="user_phone">
            </div>
            <div class="form-group">
              <input type="submit" value="ID 찾기" class="btn btn-success py-3 px-5 btn_success" style="width: 500px;" id="searchId">
            </div>
          </form>
