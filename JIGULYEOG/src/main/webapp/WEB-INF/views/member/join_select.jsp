        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center">
              <h2 class="heading">Join_Select</h2>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="person-donate text-center bg-light pt-4">
            ...
            <div class="donate-info">
              ...
              <div class="donate-amount d-flex">
                <div class="amount join_select" style="width: 100%;" onclick="location.href='registUserForm.do'">Join</div>
              </div>
            </div>
          </div>    
        </div>
        ...
        <div class="col-md-6 col-lg-3 mb-5" style="max-width: 40%; flex: none; display: inline-block; margin: 0 auto;">
          <div class="person-donate text-center bg-light pt-4">
            ...
            <div class="donate-info">
              ...
              <div class="donate-amount d-flex">
                <div class="amount join_select" style="width: 100%;" onclick="location.href='registOrgForm.do'">Join</div>
              </div>
            </div>
          </div>    
        </div>
