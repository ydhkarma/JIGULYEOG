				...
				<div class="container">
					<div class="row align-items-center justify-content-center">
						<div class="col-md-7 text-center">
							<h2 class="heading">환경단체 마이페이지</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="">
				<div class="text-center">
					<img
						src="${pageContext.request.contextPath}/resources/upload/images/user/${user.getUser_pic() }"
						width="200px"><br> <br>
					<div class="text-center">
						<h3>내 정보</h3>
						<table class="container" style="width: 500px;">
							...
							<tr>
								<th>아이디</th>
								<td><input type="text" value="${user.getUser_id() }"
									class="form-control" readonly></td>
							</tr>
							<tr>
								<th>단체명</th>
								<td><input type="text" value="${user.getUser_name() }"
									class="form-control" readonly></td>
							</tr>
							<tr>
								<th>대표자</th>
								<td><input type="text" value="${user.getUser_nick() }"
									class="form-control" readonly></td>
							</tr>
							<tr>
								<th>전화번호</th>
								<td><input type="text" value="${user.getUser_phone() }"
									class="form-control" readonly></td>
							</tr>
							<tr>
								<th>주소</th>
								<td><input type="text" value="${user.getUser_addr() }"
									class="form-control" readonly></td>
							</tr>
						</table>
					</div>
					<input type="button" value="수정"
						class="btn btn-success py-2 px-5 m-3"
						onclick="location.href='org_pw_chkform.do'">
				</div>
			</div>
		</div>
	</div>
